  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 rounded-none border border-primary hover:shadow-[0_0_20px_hsl(var(--accent)/0.3)] transition-all duration-300",
        gold: "bg-gradient-to-r from-[hsl(var(--gold-dark))] to-[hsl(var(--gold))] text-primary-foreground hover:shadow-[0_0_20px_hsl(var(--gold)/0.5)] rounded-sm transition-all duration-300",
      },
      size: {
